...
```
/plugins install https://github.com/null0xxx/kimi-atlas/releases/tag/v1.4.0
...
- [`docs/superpowers/plans/2026-07-24-atlas-runtime-token-optimization.md`](docs/superpowers/plans/2026-07-24-atlas-runtime-token-optimization.md) — analysis of where an atlas RUN spends runtime tokens on Kimi Code and the risk-gate approach to cut them without weakening the quality floor (next initiative)
