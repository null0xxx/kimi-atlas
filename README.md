...
```
/plugins install https://github.com/null0xxx/kimi-atlas/releases/tag/v1.5.2.1
...
- [`docs/superpowers/plans/2026-07-26-phase0-packet-by-reference-plan.md`](docs/superpowers/plans/2026-07-26-phase0-packet-by-reference-plan.md) — Phase 0: stop the root re-emitting 31,216 B of agent role bodies every pass (−14.3% cost-weighted from ~5 lines of prose, zero new trusted code), with the fail-open guard that change requires
